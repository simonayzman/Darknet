...
{
	[DisallowMultipleComponent, AddComponentMenu("UI/Tooltip", 58), RequireComponent(typeof(RectTransform)), RequireComponent(typeof(CanvasGroup)), RequireComponent(typeof(ContentSizeFitter))]
	public class UITooltip : MonoBehaviour {
		...
		protected virtual void Internal_Show()
		{
			...
			this.EvaluateAndCreateAttributeRows();
		...
		/// <summary>
		/// Evaluates and creates the attribute rows.
		/// </summary>
		private void EvaluateAndCreateAttributeRows()
		{
