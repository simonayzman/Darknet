			...
			else if (transition == Selectable.Transition.Animation)
			{
				...
				if (animator == null || animator.runtimeAnimatorController == null)
				{
					...
					if (GUI.Button(controlRect, "Auto Generate Animation", EditorStyles.miniButton))
					{
						...
						AnimatorController animatorController = UIAnimatorControllerGenerator.GenerateAnimatorContoller(this.serializedObject.FindProperty("animationTriggers"), this.target.name);
