				...
				else
				{
					...
					if (animator == null || animator.runtimeAnimatorController == null)
					{
						...
						if (GUI.Button(controlRect, "Auto Generate Animation", EditorStyles.miniButton))
						{
							...
							AnimatorController animatorController = UIAnimatorControllerGenerator.GenerateAnimatorContoller(this.m_AnimationTriggersProperty, this.m_TargetGameObjectProperty.objectReferenceValue.name);
